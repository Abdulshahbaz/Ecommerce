                 ...
                 <div class="col-lg-6 col-md-6">
                     <div class="header__top__right">
                         ...
                         <div class="header__top__right__language">
                             <img src="{{asset('file/img/language.png')}}" alt="">
                             <div>English</div>
         ...
         <div class="row">
             <div class="col-lg-3">
                 <div class="header__logo">
                     <a href="./index.html"><img src="{{asset('file/img/logo.png')}}" alt=""></a>
                 </div>
             </div>
             <div class="col-lg-6">
             ...
             <div class="col-lg-3">
                 <div class="header__cart">
                     <ul>
                         <li><a href="#"><i class="fa fa-heart"></i> <span id="heart-count">0</span></a></li>
